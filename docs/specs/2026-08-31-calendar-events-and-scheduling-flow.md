...
фаза 4 готова и ждёт мержа. Не сделан п. 7.6 — перенос старых серий, причина там же.
Дальше фаза 5.
...
| 5 | Кнопка «Начать пробный» на событии, ICS | +1 (номер по факту) | 1–2 дня | следующая |
